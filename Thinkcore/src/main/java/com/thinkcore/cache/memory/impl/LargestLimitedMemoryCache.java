 ...
 * limit size then the bitmap which has the largest size is deleted from cache.<br />
 * <br />
...
public class LargestLimitedMemoryCache extends LimitedMemoryCache {
    /**
     * Contains strong references to stored objects (keys) and sizes of the
     * objects. If hard cache size will exceed limit then object with the
     * largest size is deleted (but it continue exist at {@link #softMap} and
     * can be collected by GC at any time)
     */
    private final Map<Object, Integer> valueSizes = Collections
    ...
    protected Object removeNext() {
        ...
        Object largestValue = null;
        Set<Entry<Object, Integer>> entries = valueSizes.entrySet();
