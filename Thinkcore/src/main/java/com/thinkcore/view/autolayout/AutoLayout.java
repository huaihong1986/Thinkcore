...
public class AutoLayout {
    private String Tag = AutoLayout.class.getSimpleName();
    ...
    public void auto(Activity activity, boolean ignoreStatusBar) {
        ...
        TLog.i(Tag, "mAvailableWidth =" + mAvailableWidth + " , mAvailaleHegiht = " + mAvailaleHegiht);
    }
    ...
    private void getMetaData(Context context) {
        ...
        TLog.i(Tag, "mDesignWidth =" + mDesignWidth + " , mDesignHeight = " + mDesignHeight);
    }
