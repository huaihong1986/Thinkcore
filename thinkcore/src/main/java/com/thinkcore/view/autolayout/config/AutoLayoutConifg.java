package com.thinkcore.view.autolayout.config;
...
import com.thinkcore.view.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg {
    private final String Tag = AutoLayoutConifg.class.getSimpleName();
    ...
    public void init(Context context) {
        ...
        TLog.e(Tag, " screenWidth =" + mScreenWidth + " ,screenHeight = " + mScreenHeight);
    }
    ...
    private void getMetaData(Context context) {
        ...
        TLog.e(Tag, " designWidth =" + mDesignWidth + " , designHeight = " + mDesignHeight);
    }
