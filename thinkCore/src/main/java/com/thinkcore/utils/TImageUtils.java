...
public class TImageUtils {
    ...
    public static void getImage2SDByCompress(File file, String srcPath,
        ...
        try {
            ...
            TLog.e("getImage2SDByCompress", e.toString());
        } finally {
            try {
                if (isBm != null)
                    isBm.close();
    ...
    public static int getPictureDegreeFromExif(String path) {
        ...
        try {
            ...
            TLog.e("getPictureDegreeFromExif", e.toString());
        }
        return degree;
    }
    ...
    public static Bitmap getBitmapByResources(int resId) {
        return BitmapFactory.decodeResource(TApplication.getInstance()
                .getResources(), resId);
    }
    ...
    public static Drawable getDrawableByResourceBounded(Context context,
        ...
        try {
            ...
            TLog.e("getResourceDrawableBounded", ex.toString());
        }
        return drawable;
    }
